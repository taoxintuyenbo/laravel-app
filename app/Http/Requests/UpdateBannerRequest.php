...
class UpdateBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // 'link' => 'required|string', // Link is required and must be a valid string (URL could be added based on context)
            ...
            'image' => 'nullable|image|mimes:jpeg,png,jpg,gif,avif,webp|max:2048', // Image is optional for updating, validation rules apply if provided
        ];
    }
