...
class UpdateContactRequest extends FormRequest
{
    ...
    {
        return true; // Allow all users to update contacts; adjust this if necessary.
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => 'nullable|string|max:15', // Phone is optional but must be a string and up to 15 characters
